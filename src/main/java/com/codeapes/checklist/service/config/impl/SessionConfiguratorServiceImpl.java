package com.codeapes.checklist.service.config.impl;
 ...
 */
@Service(value = "sessionConfigService")
public class SessionConfiguratorServiceImpl implements SessionConfiguratorService {
